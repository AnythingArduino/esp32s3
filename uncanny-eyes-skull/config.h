/*
Notes by mike
1. Install TFT_eSPI and ESP32Servo
2. Use this as the User_Setup.h file in TFT ../Arduino/libraries/TFT_eSPI

//Start of file User_Setup.h
...
#define TFT1_CS 15         // SET BY MIKE TFT 1 chip select pin (set to -1 to use TFT_eSPI setup)
#define TFT2_CS 10         // SET BY MIKE TFT 2 chip select pin (set to -1 to use TFT_eSPI setup)
